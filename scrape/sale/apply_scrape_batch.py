#!/usr/bin/env python3
"""
Apply a browser scrape batch JSON result into listing_details.json / CSV / MD.

Usage:
  python3 apply_scrape_batch.py /tmp/batch.json
  # or stdin:
  cat batch.json | python3 apply_scrape_batch.py -
"""
...
from scrape_listing_details import (
    MASTER,
    load_details,
    merge_batch,
    merge_master,
...
def main():
    ...
    # browser_eval may wrap/double-encode
